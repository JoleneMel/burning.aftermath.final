...
export default class HomePage extends React.Component {
    render() {
        return (
        <center><Container id="intro">
            <br></br><br></br>
        <h1> Welcome to Burning Aftermath</h1><br></br>
        ...
        <p> Within Burning Aftermath was a world created by my friends that was used as our own table top role playing game. There is a 
           ...
           <p> Utilizing this old rule set I wanted to make part of my project come to life, that being creating player characters that would be able 
           ...
           <p> This is a small sample of the amount I have had planned with this project, I want to do a lot more with it, in the furture I have plans 
            ...
            <p>I kept thinking of ways this could be imporved for both sides, the player and the gm. The gm could have this sandbox to play with, have 
            ...
            <p>For the players there could be more capivating view, a created character with their health, power, and any other affect easy seen. Hovering 
            ...
            <p>Getting into table top gaming can be a little intimidating with all the rules just to create a character. I wanted this to feel more like 
            ...
            <p>The possibilites while exciting could also get some players to feel overwhelmed, so there would be preset adventures and stories that can 
           ...
           <p> This would also help with ease of XP being automatically added, players being able to easily level their characters, magic items being added 
